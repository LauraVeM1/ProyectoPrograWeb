        ...
        <div class="jumbotron w-50 mx-auto bg-dark" >
            <div class="row justify-content-center">
                ...
                <div class="col-sm-10" style="padding-top:20px">
                    <button id="btnRegresar" class="btn btn-danger" type="button" name="regresar" onclick="location.href='<?php echo "../Registro/RegistroEscritor.php?email=".$email."&pass=".$pass ?>'">
