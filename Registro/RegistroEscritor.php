...
<div class="container-fluid">
    <div class="row justify-content-center">
        <i class="fa fa-edit fa-4x center"style="color:black;"></i>
    </div>
    <h3 class="display text-center"style="color:black;">Regístrate a GuerraBlog</h3>
    <br>
    <div class="jumbotron w-50 mx-auto bg-dark" >
        <form method="post" action="<?php echo "../Registro/insrEscritor.php?email=".$email."&pass=".$pass ?>" id="formSignUp" name="formSignUp">
            <div class="row">
                <div class="col">
                    ...
                    <br>
                    <h5 align="left">RFC</h5>
                    <div class="input-group mb-4">
                        <div class="input-group-prepend">
                            <span class="input-group-text fa fa-user" id="rfc"></span>
                        </div>
                        <input type="text" name="rfc" id="rfc" class="form-control" placeholder="Ingrese rfc" required>
                    </div>
                    <br>
                    <h5 align="left">Dirección</h5>
                    <div class="input-group mb-4">
                        <div class="input-group-prepend">
                            <span class="input-group-text fa fa-map-marker-alt" id="direccion"></span>
                        </div>
                    ...
                    <div class="input-group mb-4">
                        <div class="input-group-prepend">
                            <span class="input-group-text fa fa-phone-alt" id="telefono"></span>
                        </div>
                        <input type="number" name="telefono" id="telefono" class="form-control" placeholder="Ingrese teléfono" required>
                    </div>
                    <br>
                    <h5 align="left">Referencias de artículos escritos</h5>
                    <div class="input-group mb-4">
                        <div class="input-group-prepend">
                            <span class="input-group-text fa fa-pager" id="referencias"></span>
                        </div>
                        <input type="text" name="referencias" id="referencias" class="form-control" placeholder="Ingrese referencias" required>
                    </div>
                    <br>
                    ...
                    <div class="input-group mb-4">
                        <div class="form-check form-check-inline">
                            ...
                            <a href="<?php echo "../Registro/terminosEscritor.php?email=".$email."&pass=".$pass ?>"class="form-check-label" for="terminos">Términos y condiciones de uso</a>
                        </div>
                    </div>
                    <br>
                    <div class="row justify-content-between">
                        <div class="col-sm-5">
                            <button id="btnRegresae" class="btn btn-danger" type="button" name="regresar" onclick="location.href='../Registro/Registro.php'">
